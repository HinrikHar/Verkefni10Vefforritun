...
const CustomButton = ({text, handleCompletedMarkmid}) => {
  return (
      <button
      className='flex items-center space-x-3 text-2xl 
      bg-teal-600 dark:bg-teal-500 px-6 py-3 
      rounded-md text-slate-200 focus:outline-none focus-visible:ring-4
      ...
      autoFocus
      onClick={handleCompletedMarkmid}
